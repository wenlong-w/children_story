...
import com.wenyansoft.everyday.ibatis.service.DiaryService;
...
public class DiaryServlet extends HttpServlet {
	...
	public void execute (String methodName, Object...parameterTypes) {
		...
		Class diaryServletcalss = DiaryService.class;
		
		Method method = null;

		//通过反射获取方法
		try {
			method = diaryServletcalss.getMethod(methodName,
		...
		try {
			//执行相应方法
			method.invoke(DiaryService.getInstance(), parameterTypes);
