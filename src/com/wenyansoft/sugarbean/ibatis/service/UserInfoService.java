...
import com.wenyansoft.sugarbean.commons.HttpRequest;
...
public class UserInfoService {
	...
	public void codeForSession (HttpServletRequest request,
		...
		String params = "appid=" + StoryConstant.SUGARBEAN_APPID + "&secret=" + StoryConstant.SUGARBEAN_APPSECRET 
		...
		sessionTemp.setAttribute(sessionFlag, openid+"_td_wenyan_"+session_key);
