...
import com.wenyansoft.sugarbean.ibatis.service.AudioService;
...
public class AudioServlet extends HttpServlet {
	...
	public void execute (String methodName, Object...parameterTypes) {
		...
		Class storyServletcalss = AudioService.class;
		...
		try {
			//执行相应方法
			method.invoke(AudioService.getInstance(), parameterTypes);
